...
def reward_function(params):
    ...
    straight_waypoints=[34,66,86,172,173,174,208,209,210,211,212,213]
    basic_right=[35,36,42,43,44,67,68,71,87,88,92,93,130,131,166,167,168,169,170,171]
    right_mid_path=[37,38,39,40,41,69,70,89,90,91,132,133,163,164,165]
    not_very_right_waypoints=[134,141,142,143,161,162]
    ...
    speed_points=straight_lines+straight_waypoints+almost_straight
