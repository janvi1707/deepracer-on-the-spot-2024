...
###########################################################
    ...
    distance_reward = 0
    normalized_car_distance_from_route = normalized_distance(optimal_waypoints[prev_closest_point_index],optimal_waypoints[next_closest_point_index],vehicle_x,vehicle_y)
